 ...
 * ***
 * Nama file         : com.intellizoo.virtualzoo.IguanaTest.java
...
public class IguanaTest {
  ...
  public void testinteract_noState() {
    ...
    Animal animal = new Iguana("Iguanay", p, 100, true);
    assertEquals("The iguana is climbing a tree", animal.interact());
  }
}
