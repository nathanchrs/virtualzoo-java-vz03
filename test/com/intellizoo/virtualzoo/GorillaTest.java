 ...
 * ***
 * Nama file         : com.intellizoo.virtualzoo.GorillaTest.java
...
public class GorillaTest {
  ...
  public void testinteract_noState() {
    ...
    Animal animal = new Gorilla("Gorillay", p, 100, true);
    assertEquals("The gorilla is playing with its toy", animal.interact());
  }
}
