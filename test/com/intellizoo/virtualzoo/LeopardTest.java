 ...
 * ***
 * Nama file         : com.intellizoo.virtualzoo.LeopardTest.java
...
public class LeopardTest {
  ...
  public void testinteract_noState() {
    ...
    Animal animal = new Leopard("Leopardy", p, 100, true);
    assertEquals("The leopard is sleeping with its family", animal.interact());
  }
}
