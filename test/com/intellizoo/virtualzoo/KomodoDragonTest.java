 ...
 * ***
 * Nama file         : com.intellizoo.virtualzoo.KomodoDragonTest.java
...
public class KomodoDragonTest {
  ...
  public void testinteract_noState() {
    ...
    Animal animal = new KomodoDragon("Dragony", p, 100, true);
    assertEquals("The komodo dragon is eating some beef that the zookeper gave", animal.interact());
  }
}
