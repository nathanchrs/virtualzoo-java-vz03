 ...
 * ***
 * Nama file         : com.intellizoo.virtualzoo.ChameleonTest.java
...
public class ChameleonTest {
  ...
  public void testinteract_noState() {
    ...
    Animal animal = new Chameleon("Chameleony", p, 100, true);
    assertEquals("The chameleon is changing its color and its color become like leaf",
                  animal.interact());
  }
}
