...
public class Controller {
  ...
  /**
   * Menampilkan kebun binatang di atas layar dengan batas yang
   * ditentukan pengguna.
   * <p>
   ...
   * <p>
   * Memilih salah satu jalan masuk (Entrance) secara acak dan
  ...
  /**
   * Menampilkan data jumlah makanan yang dibutuhkan untuk memberi makan
