...
public class BasicConsoleRenderer implements Renderer {
  ...
  public void render(Zoo zoo, Point topLeft, Point bottomRight, boolean useColor) {
    ...
    final Point gridOffset = new Point(3, 3);
    ...
    FrameBuffer fb = new FrameBuffer(rows + 5, cols + gridOffset.getCol() * 2 + 24, useColor);
    fb.clear();
    ...
    // Draw legend
    Point legendOffset = new Point(0, cols + 3).translate(gridOffset);
    ...
    fb.drawTextBox(legendOffset.translate(new Point(0, 2)),
        legendOffset.translate(new Point(0, 7)),
        "Legend", FrameBuffer.Color.BLACK, FrameBuffer.Color.WHITE);

    fb.drawTextBox(legendOffset.translate(new Point(1, 2)),
        legendOffset.translate(new Point(1, 18)),
        ". Road", FrameBuffer.Color.GRAY, FrameBuffer.Color.TRANSPARENT);
    fb.drawTextBox(legendOffset.translate(new Point(2, 2)),
        legendOffset.translate(new Point(2, 18)),
        "A Air Habitat", FrameBuffer.Color.GRAY, FrameBuffer.Color.TRANSPARENT);
    fb.drawTextBox(legendOffset.translate(new Point(3, 2)),
        legendOffset.translate(new Point(3, 18)),
        "L Land Habitat", FrameBuffer.Color.GRAY, FrameBuffer.Color.TRANSPARENT);
    fb.drawTextBox(legendOffset.translate(new Point(4, 2)),
        legendOffset.translate(new Point(4, 18)),
        "W Water Habitat", FrameBuffer.Color.GRAY, FrameBuffer.Color.TRANSPARENT);
    fb.drawTextBox(legendOffset.translate(new Point(5, 2)),
        legendOffset.translate(new Point(5, 18)),
        "r Restaurant", FrameBuffer.Color.GRAY, FrameBuffer.Color.TRANSPARENT);
    fb.drawTextBox(legendOffset.translate(new Point(6, 2)),
        legendOffset.translate(new Point(6, 18)),
        "p Park", FrameBuffer.Color.GRAY, FrameBuffer.Color.TRANSPARENT);
    fb.drawTextBox(legendOffset.translate(new Point(7, 2)),
        legendOffset.translate(new Point(7, 18)),
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < cols; col++) {
        ...
        fb.drawPoint(new Point(row, col).translate(gridOffset),
