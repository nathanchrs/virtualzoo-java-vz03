...
public class FrameBuffer {
  ...
  /**
   * Menggambar sebuah karakter pada posisi tertentu di FrameBuffer dengan warna tulisan dan latar yang ditentukan.
  ...
  /**
   * Menggambar sebuah garis horizontal pada posisi yang ditentukan dengan warna tulisan dan latar yang ditentukan.
  ...
  /**
   * Menggambar sebuah garis vertikal pada posisi yang ditentukan dengan warna tulisan dan latar yang ditentukan.
   * @param P1 Posisi awal garis yang akan digambar.
   * @param P2 Posisi akhir garis yang akan digambar.
   * @param content Karakter yang merepresentasikan garis yang akan digambar.
   * @param fgColor Warna tulisan (foreground) dari garis yang akan digambar.
  ...
  /**
   * Menggambar sebuah text box di FrameBuffer
   ...
   */
  public void drawTextBox(Point topLeft, Point bottomRight, String str, Color fgColor, Color bgColor) {
    if(str.length() > 0) {
      int it = 0;
      boolean done = false;
  ...
  /**
   * Menggambar sebuah persegi panjang di FrameBuffer
   * pada posisi kiri atas dan kanan bawah yang ditentukan dengan warna tulisan dan latar yang ditentukan.
   * @param topLeft Posisi kiri atas dari text box yang akan digambar.
   * @param bottomRight Posisi kanan bawah dari text box yang akan digambar.
   * @param borderCharacter Karakter yang merepresentasikan garis pembatas persegi panjang yang akan digambar.
